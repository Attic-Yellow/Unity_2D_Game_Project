...
public class GameManager : MonoBehaviour
{
    ...
    // 타 클래스에서 플레이어 데이터를 저장하는 메서드
    public void DeputySave()
    {
        SaveData();
    }
    ...
    private void LoadData()
    {
        ...
        // 현재 선택된 눈사람
        string selectedSnowManTypeString = PlayerPrefs.GetString("SelectedSnowManType", SnowManType.눈사람.ToString());
        selectedSnowManType = (SnowManType)Enum.Parse(typeof(SnowManType), selectedSnowManTypeString);
    }
    ...
    private void SaveData()
    {
        ...
        // 현재 선택된 눈사람
        PlayerPrefs.SetString("SelectedSnowManType", selectedSnowManType.ToString());
